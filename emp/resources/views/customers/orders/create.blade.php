...
<head>
    ...
    <title>Create Order for {{ $customer->customerName }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p class="subtitle">For customer: <strong>{{ $customer->customerName }}</strong> (#{{ $customer->customerNumber }})</p>
            <div class="nav">
                <a href="{{ route('customer.orders', $customer->customerNumber) }}">← Back to Customer Orders</a>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <form action="{{ route('customer.orders.store', $customer->customerNumber) }}" method="POST">
                @csrf
